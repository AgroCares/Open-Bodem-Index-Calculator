...
#'    \item{M_LIME} {measure. Has field been limed in last three years (option: yes or no, boolean)}
#'    \item{M_NONINVTILL} {measure. Non inversion tillage (option: yes or no, boolean)}
#'    \item{M_SSPM} {measure. Soil Structure Protection Measures, such as fixed driving lines, low pressure tires, and light weighted machinery (option: yes or no, boolean)}
#'    \item{M_SOLIDMANURE} {measure. Use of solid manure (option: yes or no, boolean)}
#'    \item{M_STRAWRESIDUE} {measure. Application of straw residues (option: yes or no, boolean)}
#'    \item{M_MECHWEEDS} {measure. Use of mechanical weed protection (option: yes or no, boolean)}
#'    \item{M_PESTICIDES_DST} {measure. Use of DST for pesticides (option: yes or no, boolean)}
#' }
"binnenveld"
