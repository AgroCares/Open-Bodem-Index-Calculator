...
#' 
#' @export
calc_magnesium_availability <- function(A_MG_CC,A_PH_CC,A_OS_GV,A_CEC_CO, A_K_CC,
  ...
  dt.grass.other[grepl('zeeklei|veen|moerige_klei',B_BT_AK),A_SLIB_MI := A_CLAY_MI / 0.67]
  dt.grass.other[grepl('rivierklei',B_BT_AK),A_SLIB_MI := A_CLAY_MI / 0.61]
  dt.grass.other[grepl('maasklei',B_BT_AK),A_SLIB_MI := A_CLAY_MI / 0.55]
  ...
  dt.grass.other[grepl('veen', B_BT_AK),mg_pred := 4.769 - 0.001564 * A_MG_NC - 0.01021 * kg + 
  ...
  dt.grass.other[grepl('klei',B_BT_AK),mg_pred := 7.55 - 0.000278 * A_MG_NC -0.0405 * kg + 0.00003397 * A_MG_NC * kg
...
#' 
#' @export
ind_magnesium <- function(D_MG,B_LU_BRP,B_BT_AK) {
