...
obic <- function(dt) {
  ...
  # TESTING
  dt <- fread("../development/data/obic_samples2.csv")
  ...
  checkmate::assert_subset(
    ...
    choices = 
      c("ID", "YEAR", "A_N_PMN", "A_CA_CEC", "A_CEC_CO", "A_CN_RAT", "A_K_CEC", "A_CLAY_MI", "A_K_CC", "A_KALK_MI",
        ...
        "A_SAND_MI", "B_GT", "A_BT_AK", "A_C_FR", "A_MB_PFLA", "A_SB_FR", "A_B_BC", "A_VO_BC", "A_RW_BC", "A_BS_BS",    
        "A_GV_BC", "A_PV_BC", "A_AS_BC", "A_SV_BC", "B_LU10_BRP", "B_BT_AK", "B_NR_RIVM", "B_RWT_DANK", "B_RWA_DANK", "B_OV_WENR", 
