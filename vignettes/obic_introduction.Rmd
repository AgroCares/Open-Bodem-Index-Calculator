...
```{r setup, include = FALSE}
  ...
  # load packages
  library(OBIC); library(data.table); library(ggplot2);require(patchwork); library(ggpubr); library(ggradar)
...
Wienhold, B.J., Andrews, S.S., Karlen, D.L. 2004. Soil quality: a review of the science and experiences in the USA. Environmental Geochemistry and Health, 26(2-3), 89-95. Wienhold, B.J., Karlen, D.L., Andrews, S.S., Stott, D.E. 2009. Protocol for indicator scoring in the soil management assessment framework (SMAF). Renewable Agriculture and Food Systems, 24(4), 260-266.