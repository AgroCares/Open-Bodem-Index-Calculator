...
The indicator for disease resistance is based on a logistic evaluation of the organic matter concentration and can be calculated as follows.
```{r, results = FALSE, eval = FALSE}

  # calculate the indicator for the resistance of the soil against diseases and is indicated by the amount of soil life.
...
The D_NGW and D_NSW parameters can be passed to ind_nretention() to calculate an indicator score using a logistic evaluation function.
```{r, results = FALSE, eval = FALSE}
# calculate indicator for N leaching to groundwater
dt[,D_NGW := ind_nretention(D_NGW, leaching_to = "gw")]
...
The integrated management indicator score for sustainable management increases linearly with the number of points earned.
```{r,fig.width = 7, fig.height = 4,fig.fullwidth = TRUE,echo=FALSE}
