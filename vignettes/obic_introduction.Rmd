...
```{r hidden text nematodes, eval = FALSE}
...
```{r,fig.width = 7, fig.height = 4,fig.fullwidth = TRUE,echo=FALSE}
  ...
  dd <- data.table(D_NLV = S,
    ...
    PCR <- ggscatter(dd.melt.select.other[indicator == 'I_P_CR'], x = 'function_value', y = 'index_value', color = 'B_LU_BRP', title = 'I_P_CR') + 
      theme_bw()+ scale_fill_viridis_d()+ scale_color_viridis_d()
    PSE <- ggscatter(dd.melt.select.other[indicator == 'I_P_SE'], x = 'function_value', y = 'index_value', color = 'B_LU_BRP', title = 'I_P_SE') + 
      theme_bw()+ scale_fill_viridis_d()+ scale_color_viridis_d()
    PDU <- ggscatter(dd.melt.select.other[indicator == 'I_P_DU'], x = 'function_value', y = 'index_value', color = 'B_LU_BRP', title = 'I_P_DU') + 
      theme_bw()+ scale_fill_viridis_d()+ scale_color_viridis_d()
    BDI <- ggscatter(dd.melt.select.other[indicator == 'I_B_DI'], x = 'function_value', y = 'index_value', color = 'B_LU_BRP', title = 'I_B_DI') + 
      theme_bw()+ scale_fill_viridis_d()+ scale_color_viridis_d()
