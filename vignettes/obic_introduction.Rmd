...
Example of this function are given for some parcels with different attributes, as well as for different groundwatertables.
```{r,fig.width = 7, fig.height = 4,fig.fullwidth = TRUE,echo=FALSE}
...
These parameters are used by ind_nretention() to calculate an indicator score using a logistic evaluation function.
```{r, results = FALSE, eval = FALSE}
